...
%% The hyperref package allows for typesetting hyperlinks.
%% \usepackage{hyperref}
...
{\centering \includegraphics{figure_4} 
...
{\centering \includegraphics{figure_5} 
...
{\centering \includegraphics{figure_10} 
