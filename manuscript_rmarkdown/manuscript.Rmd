...
for $\kappa = 0.60$ and $\kappa = 0.70$ are similar, whereas curves for 
...
we used $\kappa = 0.70$. Lookup tables and curves for critical statistic values for central normality and empirical central
normality tests are shown in Appendix E.

```{r empirical-central-normality-kappa, warning=FALSE, message=FALSE, fig.cap=cap, fig.height=2.5}
cap <- paste0(
  "Critical test statistic $\\tau_{\\alpha = 0.95, n, \\kappa}$ of the (empirical) ",
...
cap <- paste0(
  ...
  "ECN: empirical central normality; CN: central normality"
)
...
$m_d=100$ sequences $\mathbf{X}_i$ ($i \in \{1, 2, \ldots, m_d\}$) were randomly 
...
with $\gamma \sim U\left(2, 4\right)$, resulting in a set of sequences with between $100$ and $10000$ elements. 
...
we minimised $\sum_{i=1}^{m_d = 100}\tau_{n_i, \kappa = 0.70, i}$, i.e. the mean of residual 
errors of the central 70% of elements of each sequence $\mathbf{X}_i$, summed over all sequences.
...
Lower loss indicates better transformation to central normality in the presence of outliers.}
...
\midrule
non-robust               & ---  & ---       & ---  & ---  & ---       & ---  & 4.98 \\
$p^{*}$ (step)           & 0.80 & $(0, 1]$  & 0.75 & ---  & ---       & ---  & 2.83 \\
$p^{*}$ (triangle)       & 0.80 & $(0, 1]$  & 0.00 & 0.95 & $(0, 1]$  & 0.82 & 2.63 \\
$p^{*}$ (tapered cosine) & 0.80 & $(0, 1]$  & 0.00 & 0.95 & $(0, 1]$  & 0.89 & 2.63 \\
$z$ (step)               & 1.28 & $(0, 10]$ & 2.33 & ---  & ---       & ---  & 5.04 \\
$z$ (triangle)           & 1.28 & $(0, 10]$ & 0.20 & 1.96 & $(0, 10]$ & 4.90 & 4.96 \\
$z$ (tapered cosine)     & 1.28 & $(0, 10]$ & 1.22 & 1.96 & $(0, 10]$ & 5.12 & 5.23 \\
$r$ (step)               & 0.50 & $(0, 10]$ & 0.75 & ---  & ---       & ---  & 5.07 \\
$r$ (triangle)           & 0.50 & $(0, 10]$ & 0.83 & 1.00 & $(0, 10]$ & 0.84 & 5.18 \\
$r$ (tapered cosine)     & 0.50 & $(0, 10]$ & 0.75 & 1.00 & $(0, 10]$ & 0.76 & 5.11 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
\midrule
non-robust               & ---  & ---       & ---  & ---  & ---       & ---  & 5.09 \\
$p^{*}$ (step)           & 0.80 & $(0, 1]$  & 0.81 & ---  & ---       & ---  & 2.85 \\
$p^{*}$ (triangle)       & 0.80 & $(0, 1]$  & 0.00 & 0.95 & $(0, 1]$  & 0.83 & 2.46 \\
$p^{*}$ (tapered cosine) & 0.80 & $(0, 1]$  & 0.04 & 0.95 & $(0, 1]$  & 0.88 & 2.45 \\
$z$ (step)               & 1.28 & $(0, 10]$ & 3.32 & ---  & ---       & ---  & 4.50 \\
$z$ (triangle)           & 1.28 & $(0, 10]$ & 0.42 & 1.96 & $(0, 10]$ & 4.35 & 4.08 \\
$z$ (tapered cosine)     & 1.28 & $(0, 10]$ & 0.53 & 1.96 & $(0, 10]$ & 5.08 & 4.18 \\
$r$ (step)               & 0.50 & $(0, 10]$ & 1.05 & ---  & ---       & ---  & 5.79 \\
$r$ (triangle)           & 0.50 & $(0, 10]$ & 1.04 & 1.00 & $(0, 10]$ & 1.09 & 5.89 \\
$r$ (tapered cosine)     & 0.50 & $(0, 10]$ & 1.07 & 1.00 & $(0, 10]$ & 1.08 & 5.81 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
## Assessing transformation using simulated data
...
- A \textit{clean} dataset with each sequence drawn from $\mathcal{N}(0, 1)$ and
  ...
  were shifted into the positive domain, with minimum value $1 \cdot 10^{-4}$.
...
and sum of residual errors of the central portion ($\kappa = 0.70$) were computed
...
For Yeo-Johnson transformations average ranks are shown in Table \ref{tab:comparison_methods_simulation_yeo_johnson}.
