...
This increases local variance in the log-likelihood function and create local optima that the optimiser may not handle well.
...
This makes this test more practical for assessing central normality for larger sample numbers, where other test may detect inconsequential deviations from normality.

This work has the following limitation.
