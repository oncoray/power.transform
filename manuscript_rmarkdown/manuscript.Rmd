...
we used $\kappa = 0.80$. Lookup tables and curves for critical statistic values for central normality and empirical central
...
we minimised $\sum_{i=1}^{m_d = 100}\tau_{n_i, \kappa = 0.80, i}$, i.e. the mean of residual 
errors of the central 80% of elements of each sequence $\mathbf{X}_i$, summed over all sequences.
...
\midrule
non-robust               & ---  & ---       & ---  & ---  & ---       & ---  & 6.06 \\
$p^{*}$ (step)           & 0.80 & $(0, 1]$  & 0.81 & ---  & ---       & ---  & 3.16 \\
$p^{*}$ (triangle)       & 0.80 & $(0, 1]$  & 0.00 & 0.95 & $(0, 1]$  & 0.86 & 2.93 \\
$p^{*}$ (tapered cosine) & 0.80 & $(0, 1]$  & 0.00 & 0.95 & $(0, 1]$  & 0.90 & 2.96 \\
$z$ (step)               & 1.28 & $(0, 10]$ & 2.33 & ---  & ---       & ---  & 6.21 \\
$z$ (triangle)           & 1.28 & $(0, 10]$ & 0.09 & 1.96 & $(0, 10]$ & 4.92 & 6.15 \\
$z$ (tapered cosine)     & 1.28 & $(0, 10]$ & 1.88 & 1.96 & $(0, 10]$ & 3.43 & 6.68 \\
$r$ (step)               & 0.50 & $(0, 10]$ & 0.75 & ---  & ---       & ---  & 6.25 \\
$r$ (triangle)           & 0.50 & $(0, 10]$ & 0.83 & 1.00 & $(0, 10]$ & 0.84 & 6.47 \\
$r$ (tapered cosine)     & 0.50 & $(0, 10]$ & 0.75 & 1.00 & $(0, 10]$ & 0.76 & 6.28 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
\midrule
non-robust               & ---  & ---       & ---  & ---  & ---       & ---  & 6.19 \\
$p^{*}$ (step)           & 0.80 & $(0, 1]$  & 0.81 & ---  & ---       & ---  & 3.13 \\
$p^{*}$ (triangle)       & 0.80 & $(0, 1]$  & 0.00 & 0.95 & $(0, 1]$  & 0.87 & 2.73 \\
$p^{*}$ (tapered cosine) & 0.80 & $(0, 1]$  & 0.14 & 0.95 & $(0, 1]$  & 0.91 & 2.80 \\
$z$ (step)               & 1.28 & $(0, 10]$ & 3.32 & ---  & ---       & ---  & 5.50 \\
$z$ (triangle)           & 1.28 & $(0, 10]$ & 0.30 & 1.96 & $(0, 10]$ & 5.91 & 5.78 \\
$z$ (tapered cosine)     & 1.28 & $(0, 10]$ & 0.53 & 1.96 & $(0, 10]$ & 5.08 & 5.16 \\
$r$ (step)               & 0.50 & $(0, 10]$ & 1.05 & ---  & ---       & ---  & 7.51 \\
$r$ (triangle)           & 0.50 & $(0, 10]$ & 1.04 & 1.00 & $(0, 10]$ & 1.08 & 7.61 \\
$r$ (tapered cosine)     & 0.50 & $(0, 10]$ & 1.17 & 1.00 & $(0, 10]$ & 1.54 & 8.80 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
