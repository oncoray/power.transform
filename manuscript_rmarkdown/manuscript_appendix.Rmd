...
Let $\mathbf{X} = \left\{x_1, x_2, \ldots, x_n\right\} \in \mathbb{R}^n$ be a vector of length $n$,
sorted so that $x_1 \leq x_2 \leq \ldots \leq x_n$.
Let $p_i = \frac{i - 1/3}{n + 1/3}$, with $i = 1, 2, \ldots n$ be the percentile value
corresponding to each value in $\mathbf{X}$. For tied values in $\mathbf{X}$,
percentile values are replaced by the average in their group.
Let $z_i = F^{-1}_{\mathcal{N}}(p_i)$ be the corresponding z-score, derived from the quantile function of the normal distribution.


\end{definition}

Critical values for the test statistics of the empirical central normality test 
...
\midrule
    5 & 24.02 & 21.26 & 17.37 & 14.02 & 12.04 &  9.57 &  7.64 &  5.54 & 2.35 \\
   10 & 21.58 & 18.53 & 13.82 & 10.23 &  8.75 &  7.65 &  6.79 &  5.87 & 4.23 \\
   20 & 15.12 & 13.17 & 10.03 &  7.74 &  6.80 &  6.13 &  5.58 &  5.04 & 4.07 \\
   50 &  9.99 &  8.70 &  6.69 &  5.26 &  4.67 &  4.26 &  3.92 &  3.59 & 3.02 \\
  100 &  7.13 &  6.21 &  4.83 &  3.79 &  3.38 &  3.08 &  2.87 &  2.63 & 2.24 \\ 
  200 &  5.19 &  4.54 &  3.51 &  2.77 &  2.47 &  2.26 &  2.09 &  1.92 & 1.65 \\ 
  500 &  3.47 &  3.06 &  2.38 &  1.86 &  1.65 &  1.51 &  1.40 &  1.28 & 1.08 \\
 1000 &  2.65 &  2.35 &  1.84 &  1.44 &  1.27 &  1.16 &  1.07 &  0.98 & 0.81 \\
 2000 &  2.13 &  1.91 &  1.53 &  1.20 &  1.06 &  0.96 &  0.88 &  0.79 & 0.65 \\
 5000 &  1.69 &  1.56 &  1.30 &  1.07 &  0.95 &  0.87 &  0.80 &  0.72 & 0.58 \\
10000 &  1.50 &  1.41 &  1.23 &  1.05 &  0.96 &  0.89 &  0.83 &  0.77 & 0.64 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
