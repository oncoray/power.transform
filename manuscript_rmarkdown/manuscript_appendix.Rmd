...
cap <- paste0(
  "Type I error rate as function of the test statistic $\\tau_{\\text{ecn}}$ ",
  "for five datasets, with central portion $\\kappa=0.80$. ",
  "The type I error rate is computed from $m_d=10000$ randomly sampled features, ",
...
For low type I error rates, the test statistic proposed in the main manuscript is more conservative than alternatives 
