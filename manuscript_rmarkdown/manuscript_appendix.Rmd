...
data <- data[, mget(c("residuals", "lambda", "transformation", "dataset"))]
...
\begin{table}
\begin{center}
\caption{Residual errors for features from real-world datasets after Yeo-Johnson transformation to normality. AWT: arterial wall thickness; FE: fuel efficiency; PBM: penguin body mass}
...
\begin{table}
\begin{center}
\caption{Transformation parameter $\lambda$ for features from real-world datasets after Yeo-Johnson transformation to normality. AWT: arterial wall thickness; FE: fuel efficiency; PBM: penguin body mass}
