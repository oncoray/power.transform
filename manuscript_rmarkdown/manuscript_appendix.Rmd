...
# data[outlier == FALSE, "error" := residuals]
# data[outlier == TRUE, "error" := residuals_central]
# data_baseline <- data[transformation == "conventional"][, mget(c("dataset", "outlier", "experiment_id", "error"))]
# data.table::setnames(data_baseline, "error", "reference_error")
# data <- data[data_baseline, on = c("dataset", "outlier", "experiment_id")]
# data[, "fractional_error" := error / reference_error]
...
# Add rank based on residual error for central normality.
data[, "method_rank" := rank(residuals), by = c("experiment_id", "outlier", "dataset")]
