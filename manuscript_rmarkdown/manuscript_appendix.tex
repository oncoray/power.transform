...
\section{Appendix C: Empirical central normality test critical
values}\label{appendix-c-empirical-central-normality-test-critical-values}
...
data}\label{appendix-d-assessing-transformations-using-simulated-data}
...
normalisation was done by division by the length of the feature
...
results}\label{appendix-e-experimental-results}
