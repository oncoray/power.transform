...
Critical values for the test statistic of the empirical central
normality test are found in Table
\ref{tab:empirical-central-normality-critical-statistic}. The
null-hypothesis should be rejected at significance level \(\alpha\) if
