...
\caption{Observed type I error rates for central normality tests in the presence of data sampled from central normal distributions with $\kappa \in \left\{0.6, 0.8, 1.0\right\}$. Three empirical central normality (ECN) tests were performed, parameterised with same value for the central portion $\kappa$. Additionally, the Shapiro-Wilk test was assessed. ECN: empirical central normality}\label{fig:empirical-central-normality-error_rate}
\end{figure}
