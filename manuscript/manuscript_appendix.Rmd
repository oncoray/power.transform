...
# Appendix D: Empirical central normality test
...
Other aspects of the experiment remain the same.
...
.plot_type_1_error_rate_appendix(plot_theme = plot_theme, manuscript_dir = manuscript_dir)
```

# Appendix E: Experimental results using location- and scale-invariant Box-Cox transformation
