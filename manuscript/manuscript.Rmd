...
It is feasible that standardisation of a numeric variable (e.g., through subtracting its median value and division by its interquartile range) prior to conventional transformations may achieve a similar effect in mitigating sensitivity to the distribution's location and scale.
