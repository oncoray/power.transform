...
In the previous section, we simulated data to assess invariant power transformations and their robustness against outliers. In this section, we assess these aspects using real data.
...
The angiography imaging was then assessed, and various characteristics related to the blood vessels and the disease are measured.
...
Datasets that where invariance has better properties in terms of lambda and resulting mean and standard deviation.
