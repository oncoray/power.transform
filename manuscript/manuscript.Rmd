...
Methods using the z-score of the transformed feature or the residual error yielded worse results than the non-robust method.
Different initial values, closer to the upper limits ($\delta_1 = 10.0; \delta_2 = 10.0$), led to a reduced loss.
...
In essence, parameter optimisation with MLE also affects weights.
This may lead to different optimal values for transformation parameter $\lambda$, which increases the presented loss.
