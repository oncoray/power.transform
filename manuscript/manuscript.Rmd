...
shift- and scale invariant transformation ($\lambda = 0.9$, $\sum r_i = 8.8$, $\mu_{YJ} = 1.2$, $\sigma_{YJ} = 1.1$);
and robust shift- and scale-invariant transformation ($\lambda = 0.8$, $\sum r_i = 10.6$, $\mu_{YJ} = 1.2$, $\sigma_{YJ} = 1.0$).
...
Shift- and scale-invariant transformation leads to a lower overall residual sum, indicating a better transformation.
...
shift- and scale invariant transformation ($\lambda = 0.5$, $\sum r_i = 26.8$, $\mu_{YJ} = 0.9$, $\sigma_{YJ} = 0.9$);
and robust shift- and scale-invariant transformation ($\lambda = 0.4$, $\sum r_i = 23.1$, $\mu_{YJ} = 0.8$, $\sigma_{YJ} = 0.8$).
...
Raymaekers and Rousseeuw's robust adaptation ($\lambda = 95.4$, $\sum r_i = 319$, $\mu_{YJ} = $, $\sigma_{YJ} = $);
shift- and scale invariant transformation ($\lambda = 1.5$, $\sum r_i = 326$, $\mu_{YJ} = $, $\sigma_{YJ} = $);
and robust shift- and scale-invariant transformation ($\lambda = 1.4$, $\sum r_i = 311$, $\mu_{YJ} = $, $\sigma_{YJ} = $).
...
We previously simulated data to assess invariant power transformations and their robustness against outliers. In this section, we assess these aspects using real data.
