...
The empirical test for central normality differs from other tests for normality in that the test statistic is independent of the number of samples.
This makes this test more practical for assessing central normality for larger sample numbers, where other test may detect trivial deviations from normality.
...
Likewise, we focussed on MLE to optimise parameters, and did not investigate other metrics to the same extent, due to lack of demonstrable benefit (Appendix B-D).
