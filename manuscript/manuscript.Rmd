...
p_dens_normal <- p_dens_normal + ggplot2::theme(plot.title=ggplot2::element_text(
  hjust=0.5,
...
p_yj_normal <- p_yj_normal + paletteer::scale_color_paletteer_d(
  ...
  drop = FALSE,
  guide = "none")
p_yj_normal <- p_yj_normal + ggplot2::scale_shape_discrete(guide="none")
...
p_dens_right <- p_dens_right + ggplot2::theme(plot.title=ggplot2::element_text(
  hjust=0.5,
  size=ggplot2::rel(1.0)))
...
p_yj_right <- p_yj_right + paletteer::scale_color_paletteer_d(
  ...
  drop = FALSE,
  guide = "none")
p_yj_right <- p_yj_right + ggplot2::scale_shape_discrete(guide="none")
# p_yj_right <- p_yj_right + paletteer::scale_color_paletteer_d(
#   palette = "ggthemes::Tableau_10",
#   drop = FALSE)
...
p_dens_left <- p_dens_left + ggplot2::theme(plot.title=ggplot2::element_text(
  hjust=0.5,
  size=ggplot2::rel(1.0)))
...
p_yj_left <- p_yj_left + paletteer::scale_color_paletteer_d(
  ...
  drop = FALSE,
  guide = "none")
p_yj_left <- p_yj_left + ggplot2::scale_shape_discrete(guide="none")
