...
plot_theme$plot.title$size <- ggplot2::rel(0.8)
...
For the purpose of simulation we then define the quantile function for asymmetric generalised normal distributions.
...
```{r marginal-effect-plot, echo=FALSE, fig.cap=cap, fig.height=12.0, warning=FALSE}
cap <- paste0(
