...
Figure *insert* shows bi-modal distributions, and their respective p-values using the empirical goodness of fit test.

```{r goodness-of-fit-3, warning=FALSE, message=FALSE, fig.cap=cap}
cap <- paste0("Bi-modal distributions and empirical goodness of fit test results.")
