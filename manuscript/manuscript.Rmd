...
x <- unlist(x, recursive = FALSE)
x <- lapply(seq_along(x), function(ii, x){
...
p_bc <- p_bc + ggplot2::scale_colour_discrete(
  ...
  type=list("50 %" = "#ABC6E2", "90 %" = "#779EC6", "95 %" = "#4E79A7", "99 %" = "#346394", "100 %" = "#1D4D7E"))
...
p_yj <- p_yj + ggplot2::scale_colour_discrete(
  ...
  type=list("50 %" = "#FFBD7D", "90 %" = "#FFA954", "95 %" = "#F28E2B", "99 %" = "#CD6B0B", "100 %" = "#A25000"))
