...
To assess whether the proposed power transformations lead to values of $\lambda$ that are invariant to location and scale of the distribution, we simulate three different distributions. The first distribution is a normal distribution, as previously shown in Figure \ref{fig:decreased-normality}.
...
The optimal weighting function parameters for weighted MLE are shown in Tables \ref{tab:optimal-weighting-parameters-box-cox} and \ref{tab:optimal-weighting-parameters-yeo-johnson} for robust, location- and scale-invariant Box-Cox and Yeo-Johnson transformations, respectively.
