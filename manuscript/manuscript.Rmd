...
The body mass was $(4.2 \pm 0.8) \cdot 10^3$ (mean ± standard deviation) grams.
...
The distribution of the original data was not centrally normal ($p = 0.03$).


### Longitudinal coordinates in the Ames housing dataset

Datasets where invariance has better properties in terms of lambda and resulting mean and standard deviation.
modeldata::ischemic_stroke$age
modeldata::ames$Longitudinal
