...
For modified transformations show:
- Comparison with figure 1.
- A shifted left-skewed distribution, with the same shifts.
- A shifted right-skewed distribution, with the same shifts.
...
cap <- paste0(
  ...
  "Variable $x$ consists of $10000$ values are randomly drawn from a normal distribution $\\mathcal{N}(\\mu, 1)$. ",
  "For both Box-Cox and Yeo-Johnson transformations, we would expect $\\lambda = 1$, since $x$ is already normally distributed. ",
  "Unlike the orginal power transformations, $\\lambda = 1$ is consistently found using shift-sensitive power transformations.")
