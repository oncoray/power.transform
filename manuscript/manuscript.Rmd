    ...
    for(estimation_method in estimation_methods){
      ...
      for(transformation_method in transformation_methods){
        ...
        file_name <- file.path(
          manuscript_dir,
          paste0(
            "robustness_comparison_",
            transformation_method, "_",
            estimation_method, "_", "non_robust.RDS"))
...
# Collect all files
experiments <- coro::collect(experiment_args(manuscript_dir = manuscript_dir))
optimisation_data <- lapply(experiments, readRDS)
optimisation_data <- lapply(optimisation_data, data.table::as.data.table)
optimisation_data <- data.table::rbindlist(optimisation_data, fill=TRUE)
```
