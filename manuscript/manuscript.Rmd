...
We then compute transformation parameter $\hat{\lambda}$ using the original definitions (equations \ref{eqn:box-cox-original} and \ref{eqn:yeo-johnson-original}) and the shift-sensitive definitions (equations \ref{eqn:box-cox-shift} and \ref{eqn:yeo-johnson-shift}) for each distribution, after adding a positive value $d$ to each distribution. Here, $d \in [1, 10^6]$.
...
\toprule
transformation & 0.50 & 0.20 & 0.10 & 0.05 & 0.02 & 0.01 & 0.001 \\

\midrule
rob. shift-sensitive Box-Cox     & 0.046 & 0.072 & 0.090 & 0.106 & 0.126 & 0.140 & 0.189 \\
rob. shift-sensitive Yeo-Johnson & 0.042 & 0.063 & 0.077 & 0.090 & 0.106 & 0.118 & 0.159 \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
