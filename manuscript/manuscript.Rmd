...
We focus on the Yeo-Johnson transformations because 
...
```{r lung-cancer-age, warning=FALSE, message=FALSE, fig.cap=cap, fig.height=1.5}
cap <- paste0(
  "Quantile-quantile plots for age of patients with lung cancer, expressed in years. ",
  "The left panel shows the quantile-quantile plot for the original feature ",
  "The middle panel shows the quantile-quantile plots for the feature transformed using ",
  "the conventional Yeo-Johnson transformation, and Raymaekers and Rousseeuw's robust adaptation. ",
  "The right panel shows the quantile-quantile plots for the feature transformed using ",
...
```{r penguin-body-mass, warning=FALSE, message=FALSE, fig.cap=cap, fig.height=1.5}
cap <- paste0(
...
```{r ames-latitude, warning=FALSE, message=FALSE, fig.cap=cap, fig.height=1.5}
cap <- paste0(
...
```{r top-gear, warning=FALSE, message=FALSE, fig.cap=cap, fig.height=1.5}
cap <- paste0(
  "Quantile-quantile plots for fuel consumption data in the Top Gear dataset. ",
  "The feature contains three strong outliers related to highly fuel-efficient vehicles.",
  "The left panel shows the quantile-quantile plot for the original feature. ",
  "The empirical central normality test indicates that the original feature does not deviate significantly from central normality ($p=0.76$).",
  "The middle panel shows the quantile-quantile plots for the feature transformed using ",
  "the conventional Yeo-Johnson transformation and Raymaekers and Rousseeuw's robust adaptation. ",
...
```{r ischemic-stroke, warning=FALSE, message=FALSE, fig.cap=cap, fig.height=1.5}
cap <- paste0(
  "Quantile-quantile plots for the maximum arterial wall thickness in patients with ischemic stroke. ",
  "This feature contains two strong outliers. ",
  "The left panel shows the quantile-quantile plot for the original feature. ",
  "The empirical central normality test indicates that the original feature does not deviate significantly from central normality ($p=0.56$). ",
  "The middle panel shows the quantile-quantile plots for the feature transformed using ",
  "the conventional Yeo-Johnson transformation and Raymaekers and Rousseeuw's robust adaptation. ",
  "For these, the empirical central normality test yields $p=0.01$, and $p=0.61$, respectively. ",
  "The right panel show the quantile-quantile plots for the feature transformed using ",
  "the non-robust and robust location- and scale-invariant transformations. ",
...
However, we did not find a meaningful benefit for -- nor detriment to -- model performance in a machine learning experiment of 232 real-world datasets that contained at least one numeric feature.
...
First, in our experimental results we focussed on the Yeo-Johnson transformation because of its ability to handle features with negative values, and did not evaluate the Box-Cox transformation.
Likewise, we focussed on MLE to optimise parameters, and did not investigate other metrics to the same extent, due to lack of demonstrable benefit (Appendix B).
