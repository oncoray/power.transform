...
We previously demonstrated this property using simulations, and will now demonstrate
it using examples from real datasets.

### Age in a ...

In health-related datasets patient age is a common characteristic.

Show invariance to units (days vs years)

### Body mass of penguins
modeldata::penguins$body_mass_g
