...
Applying conventional and invariant Yeo-Johnson transformations to body mass yielded the following results, see Figure \ref{fig:penguin-body-mass}:
...
Likewise, we focussed on MLE to optimise parameters, and did not investigate other metrics to the same extent, due to lack of demonstrable benefit (Appendix B-C).
